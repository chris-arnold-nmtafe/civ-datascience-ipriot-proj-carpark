...
Replace the SenseHAT (in the software development stream version of this project) with a Tkinter-based interface for simulating joystick events and displaying the parking lot information.
